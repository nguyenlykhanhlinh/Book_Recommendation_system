...
books = spark.read.csv('C:/Users/MyPC/Documents/PYTHON/Big_data/Test/goodbooks-10k/books.csv', header=True, inferSchema=True)
ratings = spark.read.csv('C:/Users/MyPC/Documents/PYTHON/Big_data/Test/goodbooks-10k/ratings.csv', header=True, inferSchema=True)
